...
export const archive = [
  ...
  ['06', 'Governed Analytics Assistant', 'AI', '42 tests', 'analytics-rag-agent'],
  ['07', 'AI Spend & Reliability Control', 'AI', '27,683 traces', 'llm-ops-analytics'],
  ['08', 'Review Intelligence Pipeline', 'AI', '21 local tests', 'review-nlp-pipeline'],
  ['09', 'Commerce Analytics Warehouse', 'Data engineering', '17 models · 73 dbt tests', 'dbt-snowflake-ecommerce'],
  ['10', 'Digital Analytics Governance Platform', 'Data engineering', '20 guard/funnel tests', 'ga-bigquery-analytics'],
  ['11', 'Real-Time Customer Event Pipeline', 'Data engineering', '11 offline tests', 'gcp-streaming-pipeline'],
  ...
  ['17', 'Global Health Convergence Story', 'BI', '4-worksheet workbook', 'tableau-storytelling'],
  ['18', 'Governed LookML Semantic Layer', 'BI', '15 contract tests', 'looker-lookml-ecommerce'],
  ['19', 'Finance Data Automation', 'BI', '6 messy exports', 'excel-powerquery-casestudy'],
