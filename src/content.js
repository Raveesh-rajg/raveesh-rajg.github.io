...
export const exhibits = [
  ...
  },
  {
    ...
    evidence: ['8/8 retrieval hit@4', '4 validation layers', '42 offline tests'],
...
export const archive = [
  ['01', 'Hospital Rate Intelligence', 'Healthcare', '45/48 description matches', 'hospital-price-intelligence'],
  ['02', 'Claims Quality & Utilization Lakehouse', 'Healthcare', '98/98 planted defects isolated', 'healthcare-claims-pipeline'],
  ['03', 'Experiment Decision System', 'Decision science', 'Validity and inference checks', 'ab-testing-framework'],
  ['04', 'Causal Impact Measurement', 'Decision science', 'Three causal methods', 'causal-inference-casebook'],
  ['05', 'Growth Accounting & Retention', 'Product', 'Cohorts and growth accounting', 'product-growth-analytics'],
  ['06', 'Governed Analytics Assistant', 'AI', 'Retrieval and guarded SQL', 'analytics-rag-agent'],
  ['07', 'AI Spend & Reliability Control', 'AI', 'Cost and reliability analytics', 'llm-ops-analytics'],
  ['08', 'Review Intelligence Pipeline', 'AI', 'Resumable review ingestion', 'review-nlp-pipeline'],
  ['09', 'Commerce Analytics Warehouse', 'Data engineering', '17 dbt models', 'dbt-snowflake-ecommerce'],
  ['10', 'Digital Analytics Governance Platform', 'Data engineering', 'Traffic, funnel and product models', 'ga-bigquery-analytics'],
  ['11', 'Real-Time Customer Event Pipeline', 'Data engineering', 'Buffered event ingestion', 'gcp-streaming-pipeline'],
  ['12', 'Demand Forecasting & Serving', 'Decision science', 'Backtested forecasting API', 'vertex-forecasting'],
  ['13', 'Insurance Fraud Triage & Loss Intelligence', 'Risk', 'Paid losses and referral scoring', 'insurance-loss-analytics'],
  ['14', 'Credit Complaint Early-Warning System', 'Risk', 'Complaint trend analysis', 'credit-complaint-intelligence'],
  ['15', 'Marketing Attribution Reality Check', 'Decision science', 'Five attribution models', 'marketing-attribution-lab'],
  ['16', 'Executive Revenue Intelligence', 'BI', 'Editable Power BI project', 'powerbi-dax-showcase'],
  ['17', 'Global Health Convergence Story', 'BI', 'Four-worksheet data story', 'tableau-storytelling'],
  ['18', 'Governed LookML Semantic Layer', 'BI', 'Governed metric definitions', 'looker-lookml-ecommerce'],
  ['19', 'Finance Data Automation', 'BI', 'Finance variance workbook', 'excel-powerquery-casestudy'],
  ['20', 'SQL Systems & Performance Casebook', 'Data engineering', 'Eight runnable SQL exercises', 'sql-puzzles'],
]
